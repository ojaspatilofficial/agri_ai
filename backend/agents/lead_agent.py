...
class LeadAgent:
    ...
    async def orchestrate_all_agents(self, farm_id: str) -> Dict[str, Any]:
        ...
        # ── Build rich context from PostgreSQL (the brain's memory) ──
        ...
        try:
            # Import and execute agents (sync agents — run in executor)
            ...
            # ── Persist ALL agent results to agent_memory_logs ──
            ...
            # ── Build shared context (with rich historical context) ──
            ...
            # ── LLM Orchestration — now with RICH context ──
            ...
            # ── Store recommendations to PostgreSQL ──
