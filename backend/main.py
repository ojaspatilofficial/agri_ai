...
app = FastAPI(
    ...
    description="Agentic AI System for Precision Agriculture — PostgreSQL + Async",
    version="2.0.0"
)
...
async def get_agent_memory(farm_id: str, agent_name: str = None, limit: int = 20):
    """View agent memory logs — what agents have computed and decided."""
    try:
...
if __name__ == "__main__":
    print("🌾 Starting Smart Farming AI System v2.0...")
    print("🗄️ Database: PostgreSQL (async + pgvector)")
